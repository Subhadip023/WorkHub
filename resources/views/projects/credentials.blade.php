...
<style>
    ...
    .project-nav-link.active {
        ...
        border-bottom-color: {{ $project->theme }} !important;
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        <div>
            <a href="{{ route('projects.show', $project) }}" class="btn btn-sm btn-outline-secondary mb-2">
                <i class="fas fa-arrow-left fa-sm mr-1"></i> Back to Project
            </a>
            <h1 class="h3 mb-0 text-gray-800 font-weight-bold d-flex align-items-center gap-2">
                <span class="badge badge-pill mr-2" style="background-color: {{ $project->theme }}; width: 14px; height: 14px; display: inline-block;"></span>
                {{ $project->name }}
                <span class="text-muted font-weight-light" style="font-size: 1.1rem;">(Credentials)</span>
            </h1>
        </div>
        <div class="mt-2 mt-sm-0">
            <button class="btn btn-primary shadow-sm font-weight-bold" data-toggle="modal" data-target="#addCredentialModal">
    ...
    <!-- Navigation Tabs Bar -->
    <div class="border-bottom mb-4 bg-white rounded px-3 py-1 shadow-sm">
        <ul class="nav">
            <li class="nav-item">
                <a href="{{ route('projects.show', $project) }}" class="project-nav-link">
                    <i class="fas fa-tasks mr-2"></i>Tasks
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('projects.show', $project) }}#notes-content" class="project-nav-link">
            ...
            <div class="card shadow mb-4" style="border-left: 4px solid {{ $project->theme }};">
                <div class="card-header py-3 d-flex align-items-center justify-content-between bg-white">
                    ...
                    <span class="badge badge-light text-muted border px-2 py-1">
                        <i class="fas fa-lock text-warning mr-1"></i> Secure Database Vault
                    </span>
                </div>
                <div class="card-body">
                    <!-- Filter Pills -->
