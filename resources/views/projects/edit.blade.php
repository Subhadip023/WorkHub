...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Edit Project: {{ $project->name }}</h1>
                ...
                <form action="{{ route('projects.update', $project) }}" method="POST" id="editProjectForm">
                    ...
                    <div class="row">
                        <div class="form-group col-md-10">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $project->name) }}" required autofocus placeholder="Enter project name">
                            @error('name')
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="color" class="form-control" id="theme" name="theme" value="{{ old('theme', $project->theme ?? '#4e73df') }}" style="padding: 3px; height: 38px;">
                            @error('theme')
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control @error('company_id') is-invalid @enderror" id="company_id" name="company_id" required>
                                <option value="personal" {{ old('company_id', $project->company_id === null ? 'personal' : '') == 'personal' ? 'selected' : '' }}>Personal Space</option>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                <option value="1" {{ old('status', $project->status) == '1' ? 'selected' : '' }}>To Do</option>
                                <option value="2" {{ old('status', $project->status) == '2' ? 'selected' : '' }}>In Progress</option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control @error('priority') is-invalid @enderror" id="priority" name="priority" required>
                                ...
                                <option value="2" {{ old('priority', $project->priority) == '2' ? 'selected' : '' }}>Medium</option>
                                <option value="3" {{ old('priority', $project->priority) == '3' ? 'selected' : '' }}>High</option>
                                <option value="4" {{ old('priority', $project->priority) == '4' ? 'selected' : '' }}>Urgent</option>
                            </select>
                            @error('priority')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group">
                        ...
                        <div id="editor-container" style="height: 250px;">{!! old('description', $project->description) !!}</div>
                        @error('description')
