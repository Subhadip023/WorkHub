    ...
    <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex gap-3">
            ...
            <a href="/projects/create"
               class="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg text-sm font-medium">
                Projects
            </a>
...
<div class="w-full flex items-center justify-center bg-orange-100 py-10">
